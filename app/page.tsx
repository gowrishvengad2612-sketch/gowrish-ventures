...
<div className="flex flex-col gap-5 text-black/70">
              ...
              <a href="#debate" onClick={() => setMenuOpen(false)}>
                Debate
              </a>
  ...
  <div className="relative mx-auto flex w-full max-w-7xl items-center justify-between">
    ...
    <div className="relative z-10 w-full max-w-2xl">
      ...
      <h1 className="text-6xl font-bold leading-[0.95] tracking-[-0.05em] sm:text-7xl md:text-8xl lg:text-[110px]">
        Gowrish
        <br />
        <span className="text-black/45">Vengad.</span>
      </h1>
   ...
   {/* RIGHT SIDE PHOTO */}
<div className="absolute right-[5%] top-1/2 hidden w-[42%] -translate-y-1/2 lg:block">

  {/* 4:5 Photo */}
  <div className="relative mx-auto aspect-[4/5] w-full max-w-[520px] overflow-hidden rounded-[2rem] border border-black/10">
